...
-- Volcando datos para la tabla db_empresa.empleados: ~9 rows (aproximadamente)
...
INSERT INTO `empleados` (`id_empleado`, `codigo`, `nombres`, `apellidos`, `direccion`, `telefono`, `fecha_nacimiento`, `id_puesto`) VALUES
	...
	(4, 'E004', 'Luis', 'Mena', 'Ciudad', '0293234', '2024-09-05', 1),
	...
	(9, 'E010', 'Katherin', 'Choc', 'Zona 7', '32547611', '2001-07-01', 2),
	(24, 'E011', 'Alexandra', 'Martinez Ruiz', 'Mexico', '55209590', '1999-12-17', 3);
